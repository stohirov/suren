...
func (r *rasterizer) run(d *Device, t *target, segs, nodes, tileOff, tileNodes, stops, tileSegOff, tileSegIdx, clipsBuf *wgpu.Buffer, atl *atlas, nx, ny int) error {
	...
	group, err := d.device.CreateBindGroup(&wgpu.BindGroupDescriptor{
		...
		Entries: []wgpu.BindGroupEntry{
			...
			{Binding: 10, TextureView: atl.view},
		},
	})
	if err != nil {
		return err
